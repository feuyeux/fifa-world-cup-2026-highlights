...
## 当前已收录（94 / 95 playlist 公开，72 场小组赛 + 16 强前 11 场中 + 7 场 1/8 决赛 + 1/4 决赛第 1 场）
...
- **1/8 决赛（8 场）**：7/8。已收录 M90-M96。**M89 德国-法国**（07/05 05:00）FIFA 尚未上传。
...
- **疑似错标条目**：playlist index #1 (vid `4HZCeb88uSI`) 标题 "Paraguay 0-1 France"，描述 "Mbappe 进球 + 1-0" + "Round of 16" + "July 4"——但 巴拉圭 在 M75（slot 74）已 1-1 (3-4) 输给德国被淘汰，法国 M89 对手应是德国，**疑似 FIFA 把 France-Sweden 集锦错标为 Paraguay-France**，暂不下载，等下一轮 `--flat-playlist` 复查。
- 7 条 NA（playlist 末尾 #96-#102：5 条已被上传者删除 + 2 条 FIFA 私享）需上传者账号 cookies，无法用本工作流下载。
